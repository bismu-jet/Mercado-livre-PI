...
def run_checker(input_file, output_file):
    ...
    print(f"{input_file} Is solution feasible: {is_feasible}")
    if is_feasible:
        print(f"{input_file} Objective function value: {objective_value}")

#run_checker('./datasets/b/instance_0011.txt', './solution_0011.txt')
