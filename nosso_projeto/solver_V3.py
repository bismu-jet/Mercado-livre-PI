...
class WaveSolver:
    ...
    def _generate_initial_solution(self) -> Tuple[float, List[int], List[int]]:
        ...
        # ... (código da heurística inalterado, pois já é robusto) ...
        order_scores = []
    ...
    def solve(self, output_file_path: str = None):
        ...
        for i in range(MAX_ITERATIONS):
            ...
            # Define o tempo para a iteração atual
            ...
            # --- CRITÉRIO DE PARADA CORRIGIDO ---
            # Só consideramos convergência se o Gurobi PROVOU a otimalidade (não por time limit)
            ...
            if new_R > current_R + CONVERGENCE_TOL:
                ...
                # Verifica se a melhora foi significativa para dar o bônus na próxima iteração
                if new_R >= current_R * significant_improvement_threshold:
                    ...
                    has_momentum = False # Melhora pequena, reseta o momentum
